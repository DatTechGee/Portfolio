    ...
    <section className="c-space section-spacing" id="services" aria-labelledby="services-heading">
      <ScrollReveal distance={30}>
        <div className="mb-12 flex flex-col items-center text-center">
          ...
          <h2 id="services-heading" className="section-title">Services I Offer</h2>
          <p className="section-copy">
            End-to-end development services tailored to bring your ideas to life — from concept to deployment.
          </p>
        </div>
      </ScrollReveal>
