...
const metrics = [
  ...
  { value: "30+", label: "Projects delivered with care" },
  { value: "15+", label: "Clients across startups & schools" },
  { value: "100%", label: "Responsive, scalable execution" },
];
    ...
    <section id="highlights" className="c-space section-spacing">
      ...
      <div className="grid gap-4 lg:grid-cols-[1.15fr_0.85fr]">
        ...
        >
          ...
          <div className="relative mb-5 flex items-center justify-between gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
            <div>
              <p className="text-sm font-semibold text-white">Built for modern teams</p>
              <p className="text-sm text-neutral-400">Fast execution, collaboration, and product-minded delivery</p>
            </div>
          ...
          <div className="relative grid gap-4 sm:grid-cols-2">
            {metrics.map((metric, index) => (
              ...
              >
                ...
                <p className="mt-2 text-sm leading-relaxed text-neutral-400">{metric.label}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
        ...
        >
          ...
          <ul className="mt-4 space-y-3">
            {perks.map((perk) => (
              <li key={perk} className="flex items-start gap-3 rounded-xl bg-black/10 p-3 text-sm text-neutral-300">
