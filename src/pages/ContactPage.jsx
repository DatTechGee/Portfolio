...
const faqs = [
  ...
  },
  {
    ...
    answer: "Reach out via the form or WhatsApp. We'll discuss your needs, I'll provide a quote, and we begin.",
  },
];
  ...
  return (
    <main className="bg-[#0a1128] min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {contactInfo.map((info, i) => (
              <ScrollReveal key={info.label} delay={i * 0.1}>
                <div className="bg-[#0f1a36] border border-white/[0.06] rounded-2xl p-6 text-center hover:border-gold/30 transition-all duration-300">
                  ...
                  <p className="dark:text-white text-neutral-800 font-medium">{info.value}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
              ...
              <AnimatePresence mode="wait">
                {submitted ? (
                  ...
                  >
                    ...
                    <button
                      type="submit"
                      className="w-full py-3 bg-gold text-navy font-semibold rounded-xl hover:bg-gold/90 transition-all"
                    >
                      Send Message
                    </button>
                  </motion.form>
      ...
      <section className="section-spacing pt-12 pb-32">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <ScrollReveal>
            <p className="dark:text-neutral-400 text-neutral-500 mb-3">
              Prefer a quick chat?
            </p>
            <a
