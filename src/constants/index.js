...
export const myProjects = [
  ...
  },
  {
    ...
    subDescription: [
      "TypeScript-powered frontend built with React and a polished modern UI.",
      "Laravel/PHP backend with structured API and database management.",
      "Composable mailbox and message flow across the full stack.",
      "Deployed live on Vercel and hosted for real users.",
    ],
    href: "https://echomail-frontend.vercel.app/",
    problem: "Managing communication and mailboxes needed a clean, unified full-stack interface with a reliable backend.",
    solution: "Built EchoMail end-to-end with a TypeScript React frontend and a PHP/Laravel backend handling data and API requests.",
    result: "Delivered a coherent, responsive email platform running in production on Vercel.",
    image: "/assets/image5.jpg",
    gradient: projectGradients[7],
    tags: [
      { id: 1, name: "React", path: "/assets/logos/react.svg" },
  ...
  },
  {
    ...
    subDescription: [
      "Brand-focused fashion presentation with a distinct visual identity.",
      "Responsive layout and product showcase.",
      "Clean CSS styling across the interface.",
    ],
    href: "https://github.com/DatTechGee/Jbrass-Fashion",
    problem: "The Jbrass brand lacked an online presence that reflected its fashion identity.",
    solution: "Designed a fashion-forward website with strong branding and a responsive product showcase.",
    result: "Gave the brand a polished, on-message online storefront.",
    image: "/assets/image2.jpg",
    gradient: projectGradients[2],
    tags: [
      { id: 1, name: "HTML", path: "" },
  ...
  },
  {
    ...
    subDescription: [
      "Academic portal tailored to BCA students.",
      "Live deployment on Vercel for easy access.",
      "Responsive and accessible interface.",
    ],
    href: "https://bcas-mu.vercel.app/",
    problem: "BCA students had no single place to access programme information or resources.",
    solution: "Built a live, responsive student portal for the BCA programme.",
    result: "Provided students with a fast, always-available web portal.",
    image: "/assets/image3.jpg",
    gradient: projectGradients[1],
    tags: [
      { id: 1, name: "HTML", path: "" },
  ...
  },
  {
    ...
    subDescription: [
      "Editorial music content with a clean layout.",
      "Responsive blog design.",
      "Live on Vercel.",
    ],
    href: "https://music-blog-nu.vercel.app/",
    problem: "Music content had no dedicated, well-presented home online.",
    solution: "Built a clean editorial music blog with strong visual presentation.",
    result: "Gave music writing a polished, readable platform.",
    image: "/assets/image8.jpg",
    gradient: projectGradients[6],
    tags: [
      { id: 1, name: "HTML", path: "" },
  ...
  },
  {
    ...
    subDescription: [
      "Social-media themed landing and hub pages.",
      "Responsive and engaging design.",
      "Live on Vercel.",
    ],
    href: "https://social-media-azure-chi-84.vercel.app/",
    problem: "A social-media content presence needed a modern, engaging web hub.",
    solution: "Built a clean, responsive social-media themed hub.",
    result: "Delivered an engaging, shareable web presence.",
    image: "/assets/image1.jpg",
    gradient: projectGradients[4],
    tags: [
      { id: 1, name: "HTML", path: "" },
  ...
  },
  {
    ...
    subDescription: [
      "Product catalog presentation for online shopping.",
      "Responsive storefront layout.",
      "Live on Vercel.",
    ],
    href: "https://shop-phee.vercel.app/",
    problem: "The ShopPhee store needed a polished front-end to present its catalog online.",
    solution: "Built a responsive, conversion-friendly storefront.",
    result: "Gave ShopPhee a clean, presentable online store.",
  ...
  },
  {
    ...
    subDescription: [
      "Beauty brand website with a refined visual identity.",
      "Product and service presentation.",
      "Live on Vercel at zarah-beauty.vercel.app.",
    ],
    href: "https://zarah-beauty.vercel.app/",
    problem: "ZarahBeauty needed a beautiful online presence matching its brand aesthetic.",
    solution: "Designed an elegant, responsive beauty-brand website.",
    result: "Gave the brand a graceful, mobile-friendly storefront.",
    image: "/assets/image7.jpg",
    gradient: projectGradients[0],
    tags: [
      { id: 1, name: "HTML", path: "" },
  ...
  },
  {
    ...
    subDescription: [
      "Health and wellness brand presentation.",
      "Calm, clean layout design.",
      "Live on Vercel.",
    ],
    href: "https://health-spring.vercel.app/",
    problem: "HealthSpring needed a trustworthy online presence to share its wellness message.",
    solution: "Built a calm, clean wellness website focused on clarity and trust.",
    result: "Delivered an approachable, informative health web presence.",
    image: "/assets/image6.jpg",
    gradient: projectGradients[8],
    tags: [
      { id: 1, name: "HTML", path: "" },
  ...
  },
  {
    ...
    subDescription: [
      "Personal brand and services presentation.",
      "Sleek, professional styling.",
      "Live on Vercel.",
    ],
    href: "https://jsflawlesstouch.vercel.app/",
    problem: "J's Flawless Touch required a professional web presence to present services.",
    solution: "Built a sleek services-focussed brand site.",
    result: "Gave the brand a polished, credible online identity.",
    image: "/assets/image4.jpg",
    gradient: projectGradients[5],
    tags: [
      { id: 1, name: "CSS", path: "" },
  ...
  },
  {
    ...
    subDescription: [
      "Grooming-service presentation with JavaScript interactivity.",
      "Modern, bold design.",
      "Live on Vercel.",
    ],
    href: "https://perfectcut.vercel.app/",
    problem: "The PerfectCut barbering business needed a modern digital presence with interactivity.",
    solution: "Built a bold, JavaScript-enhanced service site.",
    result: "Gave the business an engaging, modern online presence.",
    image: "/assets/image1.jpg",
    gradient: projectGradients[9],
    tags: [
  ...
  },
  {
    ...
    subDescription: [
      "Editorial and advocacy content for writing.",
      "Clean, inspiring layout.",
      "Live on Vercel.",
    ],
    href: "https://powerofwriting.vercel.app/",
    problem: "The message of writing's power needed a compelling online platform.",
    solution: "Created an editorial site dedicated to the value of writing.",
    result: "Gave the topic a polished, inspiring web home.",
    image: "/assets/image8.jpg",
    gradient: projectGradients[7],
    tags: [
      { id: 1, name: "HTML", path: "" },
  ...
  },
  {
    ...
    subDescription: [
      "Educational content and resource hub.",
      "Clean, friendly layout.",
      "Live on Vercel.",
    ],
    href: "https://education-six-flame.vercel.app/",
    problem: "Learners needed an inviting place to explore educational content.",
    solution: "Built a clean, friendly education hub.",
    result: "Provided an approachable online learning resource.",
    image: "/assets/image5.jpg",
    gradient: projectGradients[1],
    tags: [
      { id: 1, name: "CSS", path: "" },
  ...
  },
  {
    ...
    subDescription: [
      "Women-focused community brand site.",
      "Vibrant, modern design.",
      "Live on Vercel.",
    ],
    href: "https://girlism.vercel.app/",
    problem: "The Girlism community needed a vibrant online identity.",
    solution: "Built a colorful, empowering brand website.",
    result: "Gave the community a distinctive, shareable online home.",
    image: "/assets/image7.jpg",
    gradient: projectGradients[2],
    tags: [
      { id: 1, name: "JavaScript", path: "/assets/logos/javascript.svg" },
  ...
  },
  {
    ...
    subDescription: [
      "Beauty brand website with a strong visual identity.",
      "Modern, elegant design.",
      "Live on Vercel.",
    ],
    href: "https://beauty-forge-ten.vercel.app/",
    problem: "BeautyForge needed a distinct, modern web identity.",
    solution: "Designed an elegant modern beauty-brand site.",
    result: "Delivered a polished, distinct brand presence.",
    image: "/assets/image2.jpg",
    gradient: projectGradients[10],
    tags: [
      { id: 1, name: "HTML", path: "" },
  ...
  },
  {
    ...
    subDescription: [
      "Advocacy and editorial content on communication.",
      "Clear, engaging layout.",
      "Live on Vercel.",
    ],
    href: "https://power-of-communication.vercel.app/",
    problem: "Communication's importance needed a compelling online showcase.",
    solution: "Built a clear, engaging editorial site on communication.",
    result: "Provided an inspiring, informative platform.",
    image: "/assets/image3.jpg",
    gradient: projectGradients[6],
    tags: [
      { id: 1, name: "HTML", path: "" },
  ...
  },
  {
    ...
    subDescription: [
      "Relationship and lifestyle content hub.",
      "Warm, personal, interactive design.",
      "Live on Vercel.",
    ],
    href: "https://ruthie-relationship-lifestyle-hub.vercel.app/",
    problem: "Ruthie's lifestyle content needed a warm, engaged online home.",
    solution: "Built a personal, interactive lifestyle hub.",
    result: "Gave the content a friendly, engaging platform.",
    image: "/assets/image8.jpg",
    gradient: projectGradients[4],
    tags: [
      { id: 1, name: "JavaScript", path: "/assets/logos/javascript.svg" },
  ...
  },
  {
    ...
    subDescription: [
      "Educational content on contract basics.",
      "Clean, readable design.",
      "Live on Vercel.",
    ],
    href: "https://contract-basics.vercel.app/",
    problem: "Contract basics needed to be explained in a simple, accessible way online.",
    solution: "Built a clear, readable informational site.",
    result: "Made contract fundamentals easy to understand.",
    image: "/assets/image6.jpg",
    gradient: projectGradients[9],
    tags: [
      { id: 1, name: "CSS", path: "" },
  ...
  },
  {
    ...
    subDescription: [
      "Digital-wellbeing advocacy content.",
      "Calm, minimal design.",
      "Live on Vercel.",
    ],
    href: "https://digital-detox-one.vercel.app/",
    problem: "Digital wellbeing needed a calm, encouraging online space.",
    solution: "Built a minimal, distraction-free digital-detox site.",
    result: "Gave the wellbeing message a serene platform.",
    image: "/assets/image1.jpg",
    gradient: projectGradients[3],
    tags: [
      { id: 1, name: "HTML", path: "" },
  ...
  },
  {
    ...
    subDescription: [
      "Media and publicity services platform.",
      "Bold, professional design.",
      "Live on Vercel.",
    ],
    href: "https://media-and-publicity.vercel.app/",
    problem: "Media & Publicity needed a professional platform to present its services.",
    solution: "Built a bold, service-oriented media site.",
    result: "Gave the brand a credible, polished online presence.",
    image: "/assets/image5.jpg",
    gradient: projectGradients[2],
    tags: [
      { id: 1, name: "CSS", path: "" },
  ...
  },
  {
    ...
    href: "https://the-honest-voice.vercel.app/",
    problem: "Honest storytelling needed a refined, modern platform.",
    solution: "Built a polished editorial site with SCSS styling.",
    result: "Gave the voice a clean, contemporary home.",
    image: "/assets/image3.jpg",
    gradient: projectGradients[8],
    tags: [
      { id: 1, name: "SCSS", path: "" },
  ...
  },
  {
    ...
    subDescription: [
      "Community-service advocacy content.",
      "Warm, interactive design.",
      "Live on Vercel.",
    ],
    href: "https://the-power-of-community-service.vercel.app/",
    problem: "The value of community service needed an inspiring online presence.",
    solution: "Built a warm, interactive advocacy site.",
    result: "Gave the cause a compelling, shareable platform.",
    image: "/assets/image4.jpg",
    gradient: projectGradients[1],
    tags: [
      { id: 1, name: "JavaScript", path: "/assets/logos/javascript.svg" },
  ...
  },
  {
    ...
    href: "https://javascript-project-kohl.vercel.app/",
    problem: "Showcasing dynamic web skills required an interactive demo project.",
    solution: "Built a JavaScript-driven interactive web project.",
    result: "Presented hands-on front-end capability in a live app.",
  ...
  },
  {
    ...
    subDescription: [
      "Movie showtime browsing and ticket booking.",
      "Web-based booking flow.",
      "Full project on GitHub.",
    ],
    href: "https://github.com/DatTechGee/online_movieticket",
    problem: "Buying movie tickets required visiting the cinema in person.",
    solution: "Built an online movie-ticket booking system.",
    result: "Enabled convenient online ticket booking.",
    image: "/assets/image2.jpg",
    gradient: projectGradients[4],
    tags: [
      { id: 1, name: "Web App", path: "" },
    ],
  },
  {
    id: 45,
    ...
    subDescription: [
      "Digital exam creation and taking.",
      "Online assessment workflow.",
      "Full project on GitHub.",
    ],
    href: "https://github.com/DatTechGee/online_exam",
    problem: "Conducting exams digitally required a structured online platform.",
    solution: "Built an online examination system for digital assessments.",
    result: "Enabled streamlined digital testing.",
    image: "/assets/image8.jpg",
    gradient: projectGradients[0],
    tags: [
      { id: 1, name: "Web App", path: "" },
  ...
  },
  {
    ...
    subDescription: [
      "Restaurant menu and web presence.",
      "Online restaurant experience.",
      "Full project on GitHub.",
    ],
    href: "https://github.com/DatTechGee/online_resturant",
    problem: "The restaurant needed an online presence to showcase offerings.",
    solution: "Built an online restaurant site with a clear menu presentation.",
    result: "Gave the restaurant a polished web presence.",
    image: "/assets/image6.jpg",
    gradient: projectGradients[7],
    tags: [
      { id: 1, name: "Web App", path: "" },
  ...
  },
  {
    ...
    subDescription: [
      "Marketing site for the Scholars Nudge product.",
      "Feature and benefit presentation.",
      "Companion to the Scholars Nudge platform.",
    ],
    href: "https://github.com/DatTechGee/scholarnudge-website",
    problem: "The Scholars Nudge product needed a public-facing site to communicate its value.",
    solution: "Built a marketing website presenting the product's features and benefits.",
    result: "Gave the product a clear, persuasive web front door.",
  ...
  },
  {
    ...
    subDescription: [
      "Healthcare-oriented web application.",
      "Built with JavaScript.",
      "Full project on GitHub.",
    ],
    href: "https://github.com/DatTechGee/medicare",
    problem: "Medical workflows needed a digital companion application.",
    solution: "Developed Medicare as a JavaScript-powered healthcare web app.",
    result: "Delivered a functional digital health application.",
    image: "/assets/image5.jpg",
    gradient: projectGradients[6],
    tags: [
      { id: 1, name: "JavaScript", path: "/assets/logos/javascript.svg" },
